...
public class TestExpandableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Bundle bClass = savedInstanceState;
        ...
        super.onResume();
        mCoordinatorLayout = (CoordinatorLayout) findViewById(R.id.test_ccordinator_container);
                                        ...
                                        public void onClick(View v) {
                                            switch (v.getId()){
                                                ...
                                                case R.id.device_map_list_tv:
                                                    ...
                                                    Intent trackIntent = new Intent(TestExpandableActivity.this, viewtrack_activity.class);
                                                ...
                                                case R.id.device_change_list_tv:
                                                    ...
                                                    Intent settingsIntent = new Intent(TestExpandableActivity.this, M180SettingsActivity.class);
